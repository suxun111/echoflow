...
const mobileNavigation: { id: AppView; label: string; icon: string }[] = [
  { id: 'home', label: '首页', icon: 'home' },
  { id: 'discover', label: '发现', icon: 'compass' },
  { id: 'uploads', label: '个人上传', icon: 'upload' },
  { id: 'vocabulary', label: '生词本', icon: 'book' },
]
